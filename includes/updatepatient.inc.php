<?php
    ...
    $updateSQL = "UPDATE patients SET p_first = '$p_first', p_last = '$p_last', p_dob = '$p_dob', p_sex = '$p_sex', 
                        p_addr = '$p_addr', p_city = '$p_city', p_state = '$p_state', p_zip = '$p_zip', p_phone1 = '$p_phone1', 
                        p_phone2 = '$p_phone2', p_email = '$p_email', allergies = '$p_allergies',  insurer = '$p_insurer', 
                        ins_id = '$p_ins_id', pcp_name = '$pcp_name', pcp_addr = '$pcp_addr', pcp_phone = '$pcp_phone' WHERE p_id = $pid";
